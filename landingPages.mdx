...
<Steps>
  <Step title="Add a new page on-site">
    ...
    Most brands reference the campaign type in the page url (i.e `company.com/students`) and add a simple title/description highlighting their offers.
  </Step>
...
<Steps>
  ...
  <Step title="Add OfferHub iFrame to body">
    ...
    ```html iFrame
      <gocertify-iframe data-src="/at/exampleCompany/hub"></gocertify-iframe>
    ```
    <Info>
      Remember to replace `exampleCompany` with your actual company name.
    </Info>
  </Step>
