...
<Accordion title="Integrating with Shopify" icon="shopify">
    We can fetch codes directly from your Shopify discount feed. We will create a new unique code for each shopper, ensuring that you never run out of codes and can track the performance of each code.
</Accordion>
