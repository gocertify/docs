...
<Accordion title="Integrating with Uniqodo" icon="ticket-simple">
    Provide us with your Uniqodo `API key` and `offer ID` (e.g. 9384) and we'll automatically add shoppers to your campaign. You can also upload a CSV of discount codes as a fallback.
</Accordion>
