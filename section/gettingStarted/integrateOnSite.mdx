  ...
  <Accordion icon="network-wired" title="Awin Mastertag">
    ...
    <Steps>
      <Step title="Navigate to the plugin Store">
        ...
        <Frame>
          <img src="/images/other/awinFeatured.png" alt="Awin gocertfiy Plugin" />
        </Frame>
      </Step>
  ...
  <Accordion icon="shopify" title="Shopify">
    ...
    <Step title="Navigate to the Shopify app">
      ...
      <Step title="Install the app">
        ...
        <Frame>
          <img src="/images/integrations/ecommerce/shopify/shopify-install-screen1.png" alt="Shopify install screen" />
        </Frame>
      </Step>
      <Step title="Connect to your brand">
        ...
        <Frame>
          <img src="/images/integrations/ecommerce/shopify/shopify-connect-screen1.png" alt="Shopify connect screen" />
        </Frame>
      </Step>
      <Step title="Select your brand">
        ...
        <Frame>
          <img src="/images/integrations/ecommerce/shopify/shopify-connect-screen2.png" alt="Shopify connect screen" />
        </Frame>
      </Step>
      <Step title="Navigate to the embed page">
        ...
        <Frame>
          <img src="/images/integrations/ecommerce/shopify/shopify-enablescript-screen1.png" alt="Shopify connect screen" />
        </Frame>
      </Step>
      <Step title="Enable your embed script">
        ...
        <Frame>
          <img src="/images/integrations/ecommerce/shopify/shopify-enablescript-screen2.png" alt="Shopify connect screen" />
        </Frame>
      </Step>
      <Step title="Add on-site messaging">
        ...
        <Frame>
          <iframe
            src="https://www.loom.com/embed/f0751b810299485c958d8412c872ded8?sid=c34ab8ef-9432-4dc6-a7bb-6f16f96dda90"
            frameborder="0"
