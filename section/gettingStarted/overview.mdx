...
With gocertify you can create as many of these custom reward flows as you want and tailor them to your brand and your audience. For example, creating a campaign around [unique rewards](/section/buildRewardFlows/chooseReward) (10% off or Free delivery), gating offers to specific [target
audiences](/section/buildRewardFlows/closedUserGroups) (e.g. Key workers or Students), and leveraging our [Data Capture](/section/captureData/overview) features to exchange rewards for valuable first party data (i.e. Email or D.O.B).
