...
To set up a popup simple add an onclick event to your given CTA, button or link and call the gocertify.popup function.
...
<Card title="Popups" img="/images/OSM-popUp.png">
