...
<img src="/images/osm/OSM-cta.png" alt="Dynamic Text" style={{ borderRadius: '0.5rem' }} />
  ...
  <Accordion title="Google Tag Manager" icon="tag">
    ...
    <Steps>
      <Step title="Identify Variable Name">
        ...
        <img src="/images/other/GTM-variables.png" alt="GTM Variables" style={{ borderRadius: '0.5rem' }} />
      </Step>
        ...
        <img src="/images/other/GTM-tag-variable.png" alt="GTM Head Script" style={{ borderRadius: '0.5rem' }} />
      </Step>
      <Step title="Save and Publish">
        Save and publish your changes. You should now see dynamic text in your on site messages.
        <img src="/images/other/GTM-publish.png" alt="GTM Publish" style={{ borderRadius: '0.5rem' }} />
      </Step>
    </Steps>
  </Accordion>
