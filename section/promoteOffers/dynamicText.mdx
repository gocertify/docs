...
We do this by adding two extra data attributes called `data-purchase-amount` and `data-locale`, and the way of setting them will depend on
the integration you are using (See details below).
