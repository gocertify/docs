...
<CardGroup cols={1}>
  <Card title="In-line" href="/section/promoteOffers/on-site-placements" img="/images/osm/inlinePlacementOSM.png">
...
<img
  ...
  src="/images/osm/osm-inline-dashboard.png"
...
<img
  className="block dark:hidden"
  src="/images/other/cssAnchor.png"
  alt="CSS Anchor"
  style={{ borderRadius: '0.5rem' }}
/>
<img
...
<img
  className="block dark:hidden"
  src="/images/osm/osm-inline-copy-code.png"
