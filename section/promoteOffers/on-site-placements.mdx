...
No additional development work is needed to add OSM to your site as long as the [head script](section/gettingStarted/integrateOnSite) has been installed.

## Types of on-site messaging
Out of the box, gocertify supports three main types of on-site messaging, but with heavy customisation available you can build a tailored placement that meets your needs.
