...
After that screen, when the user successfully verifies as a target group (student, healthcare, senior, etc), Gocertify will update the Contact, setting a new field called “gocertify\*student*verified_at” with the current date, useful to generate \_Segments*.
...
<Accordion title="See step by step tutorial">
    <Steps>
        <Step title="Create a new API Credentials">
            ...
            src="/images/integrations/cdp/emarsys/emarsysSecuritySettings.png"
        ...
        <img
        className="block dark:hidden"
        src="/images/integrations/cdp/emarsys/emarsysAPICredentials.png"
        ...
        <img
        className="block dark:hidden"
        src="/images/integrations/cdp/emarsys/emarsysAPICredentialsChoose.png"
        alt="Emarsys API Credentials"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        ...
        <img
        className="block dark:hidden"
        src="/images/integrations/cdp/emarsys/emarsysOpenIDUser.png"
        alt="Emarsys API key"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        ...
        <div style={{ background: '#FFF4E5', border: '1px solid #FFA726', borderLeft: '4px solid #FF5722', color: '#BF360C', padding: '1rem', borderRadius: '0.5rem', margin: '1rem 0', fontWeight: 500, display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
          <div style={{ color: '#FF5722', fontSize: '1.2rem', fontWeight: 'bold', marginTop: '0.1rem' }}>⚠️</div>
          <div><strong style={{ color: '#BF360C' }}>Caution:</strong> Please note that, as the orange warning strip at the top indicates, this is the only time this secret is displayed. If you navigate away from this page without making a note of it, it is impossible to retrieve the secret and new credentials have to be generated.</div>
        </div>

        </Step>

        <Step title="Share the user details with Gocertify">
        Go to onetimesecret.com and paste the copied Client ID and Client Secret. Even if it's not required, we encourage you to also add a random “Passphrase”.
    ...
    Authorise the API Credentials to do all the automations we described in the overview, enabling all the checkboxes shown below:
    <img
    className="block"
    src="/images/integrations/cdp/emarsys/emarsysPermissions.png"
    ...
    <img
    className="block dark:hidden"
    src="/images/integrations/cdp/emarsys/emarsysFieldEditor.png"
...
Once the user shares their information with your brand, you will see a new Contact in your base, with the email and mobile _number_ (if it's enabled) and the respective Opt-in fields set as _true_ (_Opt-in_ and _Mobile SMS Opt-In_).
...
<Frame caption="Example shopper profile within Emarsys">
  <img
    className="block dark:hidden"
    src="/images/integrations/cdp/emarsys/emarysysShopper.png"
    alt="Example shopper"
    style={{ borderRadius: "0.5rem" }}
  />
  <img
...
<Frame caption="Example of how to segment Gocertify shoppers within Emarsys">
  <img
    className="block dark:hidden"
    src="/images/integrations/cdp/emarsys/emarsysSegmentation.png"
