...
<Accordion title="See step by step tutorial">
  <Steps>
    <Step title="Access Project Settings">
      ...
      <img className="block" src="/images/integrations/cdp/bloomreach/projectSettings.png" alt="Bloomreach Project Settings" style={{ borderRadius: '0.5rem' }} />
    </Step>

    <Step title="Navigate to API Settings">
      In the left sidebar, go to “Access management” and then select “API”.

      <img className="block" src="/images/integrations/cdp/bloomreach/apiSettings.png" alt="Bloomreach API Settings" style={{ borderRadius: '0.5rem' }} />
    </Step>

    <Step title="Create a new group ">
      In the “API groups” section, open the dropdown selector and choose “+New group”

      <img className="block" src="/images/integrations/cdp/bloomreach/newApiGroup.png" alt="Bloomreach New API Group" style={{ borderRadius: '0.5rem' }} />
    </Step>
    ...
    <Step title="Create the Gocertify group">
      ...
      <img className="block" src="/images/integrations/cdp/bloomreach/apiGroup.png" alt="Bloomreach API Group" style={{ borderRadius: '0.5rem' }} />
    </Step>
    ...
    <Step title="Set the permissions">
      ...
      <img className="block" src="/images/integrations/cdp/bloomreach/groupPermissions.png" alt="Bloomreach Group Permissions" style={{ borderRadius: '0.5rem' }} />
    ...
    <Step title="Find your Hard ID">
      ...
      <img className="block" src="/images/integrations/cdp/bloomreach/hardID.png" alt="Bloomreach Hard ID" style={{ borderRadius: '0.5rem' }} />
    </Step>
    ...
    <Step title="Share the user details with Gocertify">
      ...
      <img className="block" src="/images/integrations/cdp/bloomreach/oneTimeSecret.png" alt="Onetime Secret" style={{ borderRadius: '0.5rem' }} />
...
<Frame caption="First Bloomreach Event">
  <img className="block" src="/images/integrations/cdp/bloomreach/firstEvent.png" alt="First Bloomreach Event" style={{ borderRadius: '0.5rem' }}/>
</Frame>
...
<Frame caption="Second Bloomreach Event for verified groups">
  <img className="block" src="/images/integrations/cdp/bloomreach/secondEventVerified.png" alt="Second Bloomreach Event for verified groups" style={{ borderRadius: '0.5rem' }}/>
</Frame>
...
<Frame caption="For external offers that don't require verification (often included in the OfferHub), the Second request will be slightly different, as it won't include the “group_xxx” keys">
  <img className="block" src="/images/integrations/cdp/bloomreach/secondEventOpenOffers.png" alt="Second Bloomreach Event for open offers" style={{ borderRadius: '0.5rem' }}/>
</Frame>
...
<Frame caption="Project settings > Privacy management > Consents">
  <img className="block" src="/images/integrations/cdp/bloomreach/consentManagement.png" alt="Project settings > Privacy management > Consents" style={{ borderRadius: '0.5rem' }}/>
</Frame>
...
<Frame caption="Bloomreach Filters">
  <img className="block" src="/images/integrations/cdp/bloomreach/filters.png" alt="Bloomreach Filters" style={{ borderRadius: '0.5rem' }}/>
</Frame>
