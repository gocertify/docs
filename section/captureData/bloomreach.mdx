...
<Accordion title="See step by step tutorial">
    <Steps>
        <Step title="Access Project Settings">
            ...
            src="/images/bloomreachProjectSettings.png"
        ...
        In the left sidebar, go to “Access management” and then select “API”.
            <img
            className="block dark:hidden"
            src="/images/bloomreachApiSettings.png"
            alt="Bloomreach API Settings"
            style={{ borderRadius: '0.5rem' }}
            />
            <img
            className="hidden dark:block"
        ...
        <img
        className="block dark:hidden"
        src="/images/bloomreachNewApiGroup.png"
        alt="Bloomreach New API Group"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        className="hidden dark:block"
        ...
        <img
        className="block dark:hidden"
        src="/images/bloomreachApiGroup.png"
        alt="Bloomreach API Group"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        className="hidden dark:block"
        ...
        This means you will allow us to only “create new type of events”. If you already have a “consent” event on that list (under the “Other” section), please enable it too.

        <img
        className="block dark:hidden"
        src="/images/bloomreachGroupPermissions.png"
        alt="Bloomreach Group Permissions"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        className="hidden dark:block"
        ...
        <img
        className="block dark:hidden"
        src="/images/bloomreachHardID.png"
        alt="Bloomreach Hard ID"
        style={{ borderRadius: '0.5rem' }}
        />
        <img
        className="hidden dark:block"
        ...
        <Step title="Share the user details with gocertify">
            ...
            <img
            className="block dark:hidden"
            src="/images/bloomreachOneTimeSecret.png"
            alt="Onetime Secret"
            style={{ borderRadius: '0.5rem' }}
            />
            <img
...
<Frame caption="First Bloomreach Event">
    <img
    className="block dark:hidden"
    src="/images/bloomreachFirstEvent.png"
    alt="First Bloomreach Event"
    style={{ borderRadius: '0.5rem' }}
    />
    <img
    className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/images/bloomreachSecondEventVerified.png"
  alt="Second Bloomreach Event for verified groups"
  style={{ borderRadius: '0.5rem' }}
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/images/bloomreachSecondEventOpenOffers.png"
  alt="Second Bloomreach Event for open offers"
  style={{ borderRadius: '0.5rem' }}
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/images/bloomreachFilters.png"
  alt="Bloomreach Filters"
  style={{ borderRadius: '0.5rem' }}
/>
<img
  className="hidden dark:block"
