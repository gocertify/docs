...
<Step title="Access project settings">
   ...
   <img
    ...
    src="/images/ometriaSettings.png"
...
<Step title="Add new API key">
    ...
    <img
    className="block dark:hidden"
    src="/images/ometriaNewAPIKey.png"
...
<Step title="Name your API key">
     ...
     <img
    className="block dark:hidden"
    src="/images/ometriaNameAPIKey.png"
...
<Step title="Share with gocertify">
    ...
    <img
    className="block dark:hidden"
    src="/images/ometriaOneTimeSecret.png"
...
<img
  className="block dark:hidden"
  src="/images/ometriaFilterSegment.png"
...
<img
  className="block dark:hidden"
  src="/images/ometriaCreateCondition.png"
...
<img
  className="block dark:hidden"
  src="/images/ometriaCustomerFilter.png"
